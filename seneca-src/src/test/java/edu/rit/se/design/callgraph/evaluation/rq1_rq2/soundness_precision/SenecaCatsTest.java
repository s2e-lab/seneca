...
/**
 * Automated dynamic test for verifying edu.rit.se.design.callgraph.cli.Seneca's soundness with respect to deserialization features.
 *
 * @author Joanna C. S. Santos (jds5109@rit.edu)
 */
public class SenecaCatsTest extends AbstractCatsTest {

    protected SenecaCatsTest() {
        super(TestUtilities.CATS_STATIC_CGS_FOLDER, "Seneca");
    }
