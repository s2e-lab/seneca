...
public class RankDirHierarchicalLayout extends PipeBase implements Layout {
    ...
    public RankDirHierarchicalLayout(Rendering renderingType) {
    ...
    protected void renderBox(Box box) {
        ...
        for (int i = 0; i < box.size(); i++) {
            Node n = box.get(i);
            int labelSize = n.hasAttribute("ui.label")?(Integer)  n.getAttribute("ui.label") : 1;
            System.out.println("n.id = " +n.getId() + "n.labelSize= "+labelSize+ " n.box = "+box);
        ...
        if (box.parent != null) {
            ...
            System.out.println("parentBox.size() = " +parentBox.size());
    ...
    public static void main(String... args) {
        ...
        RankDirHierarchicalLayout hl = new RankDirHierarchicalLayout(Rendering.HORIZONTAL);
        gen.addSink(g);
        gen.begin();
        for (int i = 0; i < 20; i++)
            gen.nextEvents();
