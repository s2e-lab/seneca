...
public class TC_HashedMap_Array extends CompositeArrayTestCase {

    public static void main(String[] args) throws Exception {
        TC_HashedMap_Array tc = new
                TC_HashedMap_Array(
    ...
    public TC_HashedMap_Array(AbstractSimpleTestCase simpleTestCase) {
