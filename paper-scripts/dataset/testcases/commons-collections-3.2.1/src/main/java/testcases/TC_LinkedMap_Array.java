...
public class TC_LinkedMap_Array extends CompositeArrayTestCase {

    public static void main(String[] args) throws Exception {
        TC_LinkedMap_Array tc = new
                TC_LinkedMap_Array(
    ...
    public TC_LinkedMap_Array(AbstractSimpleTestCase simpleTestCase) {
